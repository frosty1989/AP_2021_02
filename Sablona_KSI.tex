...
\newcommand{\logoCVUT}{\includegraphics{copsu_logo.jpg}} % logo ČVUT -- podle grafického manuálu ČVUT platného od prosince 2016. Pokud nevyhovuje PDF-verze, tak použijte jinou variantu loga: https://www.cvut.cz/logo-a-graficky-manual -> "Symbol a logo ČVUT v Praze"). Pokud chcete logo úplně vynechat, zadejte místo "\includegraphics{...}" text "\vspace{35mm}"
...
\newcommand{\prohlaseni}{Prohlašuji, že jsem svou absolventskou práci vypracoval\woman{} samostatně a použil\woman{} jsem pouze podklady (literaturu, projekty, SW atd.) uvedené v přiloženém seznamu.} % text prohlášení můžete mírně upravit :-)

\newcommand{\podekovani}{Děkuji vedoucímu práce Mgr. Bc. Miroslavu V. Hospodářskému za neocenitelné rady a pomoc při tvorbě absolventské práce.} % NAPIŠTE poděkování, např. svému vedoucímu:
